...
/**
 * Pet Service
 * Handles pet customization preferences (name, species, color).
 * Endpoints: GET/PUT /users/preferences/pet
 */
const petService = {
  /**
   * Load pet customization preferences.
   * @returns {Promise<{ pet_name: string|null, pet_species: string|null, pet_color: string|null }>}
   */
   ...
   * @param {{ pet_name?: string|null, pet_species?: string|null, pet_color?: string|null }} payload
   * @returns {Promise<{ pet_name: string|null, pet_species: string|null, pet_color: string|null }>}
   */
