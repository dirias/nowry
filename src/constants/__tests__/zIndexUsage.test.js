 ...
 * (PomodoroFAB.js, Header.js). StudyPet.js and StudySession.js self-verify
...
const POMODORO_FAB_PATH = path.join(__dirname, '../../components/Pomodoro/PomodoroFAB.js')
...
describe('zIndexUsage — nav consumers import from centralized module', () => {
  it('PomodoroFAB.js imports Z_NAV from the centralized constants module and holds no residual zIndex: 1100', () => {
    const source = fs.readFileSync(POMODORO_FAB_PATH, 'utf8')
