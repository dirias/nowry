 ...
 * bundle from 4.8MB to 6.9MB, shipping all 1818 icons for the sixty this product
 * uses. Named imports from the package root did not help either: Metro resolves
 * lucide's single ESM bundle and does not tree-shake it. Importing each icon
 * from `lucide-react-native/icons/<name>` is what actually pays.
 */
